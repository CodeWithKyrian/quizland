...
<div class="relative bg-white dark:bg-zinc-800 p-4 sm:p-6 rounded-md shadow-sm overflow-hidden my-8">
    ...
    <div class="relative">
        <h1 class="text-2xl md:text-3xl text-zinc-800 dark:text-white font-bold mb-1">{{$title}}</h1>
